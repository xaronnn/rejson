 ...
 * stop index. Index values can be negative. Out of range errors are treated by rounding the index
 * to the arrays start/end. An inverse index range will return unfound. Returns the index of of the
 * value if found, -1 if n is not a scalar or unfound
 */
