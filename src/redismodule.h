...
int REDISMODULE_API_FUNC(RedisModule_ZsetAdd)(RedisModuleKey *key, PORT_LONGDOUBLE score,
                                              RedisModuleString *ele, int *flagsptr);
int REDISMODULE_API_FUNC(RedisModule_ZsetIncrby)(RedisModuleKey *key, PORT_LONGDOUBLE score,
                                                 RedisModuleString *ele, int *flagsptr,
                                                 PORT_LONGDOUBLE *newscore);
int REDISMODULE_API_FUNC(RedisModule_ZsetScore)(RedisModuleKey *key, RedisModuleString *ele,
                                                PORT_LONGDOUBLE *score);
int REDISMODULE_API_FUNC(RedisModule_ZsetRem)(RedisModuleKey *key, RedisModuleString *ele,
                                              int *deleted);
void REDISMODULE_API_FUNC(RedisModule_ZsetRangeStop)(RedisModuleKey *key);
int REDISMODULE_API_FUNC(RedisModule_ZsetFirstInScoreRange)(RedisModuleKey *key, PORT_LONGDOUBLE min,
                                                            PORT_LONGDOUBLE max, int minex, int maxex);
int REDISMODULE_API_FUNC(RedisModule_ZsetLastInScoreRange)(RedisModuleKey *key, PORT_LONGDOUBLE min,
                                                           PORT_LONGDOUBLE max, int minex, int maxex);
...
RedisModuleBlockedClient *REDISMODULE_API_FUNC(RedisModule_BlockClient)(
    ...
    void (*free_privdata)(void *), PORT_LONGLONG timeout_ms);
